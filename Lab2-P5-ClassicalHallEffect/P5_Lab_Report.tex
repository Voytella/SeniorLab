...
% uncomment the line below to add image
%\includegraphics[width=0.5\textwidth]{FILENAME.png}
\captionof{figure}{Hall voltage plotted as a function of applied magnetic field strength.}
\label{task24plot}
\end{figure}
...
% uncomment the line below to add image
%\includegraphics[width=0.5\textwidth]{FILENAME.png}
\captionof{figure}{Inverse voltage is plotted against inverse temperature for n-type Germanium.}
\label{task33plot}
\end{figure}
...
% uncomment the line below to add image
%\includegraphics[width=0.5\textwidth]{FILENAME.png}
\captionof{figure}{Natural logarithm of conductivity versus inverse temperature for n-type Germanium}
...
% uncomment the line below to add image
%\includegraphics[width=0.5\textwidth]{FILENAME.png}
\captionof{figure}{Hall voltage plotted as a function of applied magnetic field strength for n-type Germanium.}
\label{task34plot}
\end{figure}
