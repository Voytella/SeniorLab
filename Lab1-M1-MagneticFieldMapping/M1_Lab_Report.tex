...
\captionof {figure}{The theoretical three dimensional plot calculated by using
  Symthe's deviation of the Biot-Savart Law. The source code that produced this
  plot is provided in Appendix B. The translation of Equation
  \ref{eq:longBiotSavart} into Julia code is shown in lines 44-95.}
...
\captionof {figure}{The two dimensional plot with the data obtained during the
  ...
  $\mu$T and the radial distance from the z-axis in cm.}
