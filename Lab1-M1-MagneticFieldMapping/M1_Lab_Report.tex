...
The Helmholtz coil consists of two concentric sets of coils, each with the same
...
A DC Gaussmeter (AlphaLab Model GM-1-HS) was connected to a Hall Effect Probe in
...
%Position Controls
The position of the Hall Effect Probe can be modified in the $\rho$ direction by
...
Note that, per suggestion of the laboratory manual, the procedural steps of this
...
The Helmholtz coil is oriented such that the Earth's magnetic field is parallel
...
Note that there was an apparent offset in the Gaussmeter reading, as the 0.36G
...
% Misaligned axis
Upon initial inspection of the equipment, it appeared the center pole running
...
The majority of field strength measurements collected for the 3-dimensional
...
An ammeter was also used to ensure a 2A current was consistently applied on both
...
Upon further investigation, it appeared the current from the power supply was
...
Because the experimental set-up was restricted to a small area, the contribution
...
Using a multimeter, the resistance of a set of coils was measured to be
...
Further calculations will require knowing the number of turns of wire in each
...
When measuring at a probe height of a/2 (16cm), where 'a' is the separation
